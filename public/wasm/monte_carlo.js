...
export function monte_carlo_simulation_array(ticker, initial_price, simulations, days_in_csv, drift, volatility) {
    ...
    const ret = wasm.monte_carlo_simulation_array(ptr0, len0, initial_price, simulations, days_in_csv, drift, volatility);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('monte_carlo_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
